...
export const ALL_SCENARIOS: ScenarioDefinition[] = [
  ...
  },
  {
    ...
    targetUser: 'Emaar Facilities & Ops Mgr Tariq',
    channel: 'EMAIL',
    description: 'Upcoming scheduled quarterly maintenance alert for central chillers under AMC contract AMC-2026-0012.',
    sampleMessage: 'Reminder: Quarterly HVAC preventive maintenance under AMC-2026-0012 (Emaar) is due on Sept 30, 2026. PM order auto-drafted.',
  },
  {
    ...
    targetRole: 'CUSTOMER',
    targetUser: 'Sobha Construction Site Engineer',
    channel: 'SMS',
