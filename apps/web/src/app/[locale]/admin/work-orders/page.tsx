...
const SAMPLE_WORK_ORDERS: WorkOrderDetail[] = [
  {
    ...
    area: 'Downtown Dubai',
    customer: { companyName: 'Palm Crest Properties LLC', phone: 'xxxxxxxxx' },
    inChargeTech: {
  ...
  },
  {
    ...
    area: 'Al Barsha 1',
    customer: { companyName: 'Al-Noor Residential Compound', phone: 'xxxxxxxxx' },
    inChargeTech: {
  ...
  },
  {
    ...
    area: 'Business Bay',
    customer: { companyName: 'Crescent Bay Commercial Complex', phone: 'xxxxxxxxx' },
    inChargeTech: {
      name: 'Vikram Patel',
  ...
  },
  {
    ...
    customer: { companyName: 'Desert Rose Logistics LLC', phone: 'xxxxxxxxx' },
    inChargeTech: {
      name: 'Vikram Patel',
      trade: 'Master Electrician',
      phone: 'xxxxxxxxx',
  ...
  },
  {
    ...
    area: 'Business Bay',
    customer: { companyName: 'Blue Sky Towers Owners Association', phone: 'xxxxxxxxx' },
    inChargeTech: {
      name: 'Tariq Al-Mansoor',
      trade: 'Lead Plumber',
      phone: 'xxxxxxxxx',
